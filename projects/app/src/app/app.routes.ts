  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        title: 'Opportunités',
        loadComponent: () =>
          import('./pages/opportunities-page/opportunities-page').then((m) => m.OpportunitiesPage),
      },
      {
      ...
      },
      {
        path: 'actions',
        title: 'Actions',
        loadComponent: () => import('./pages/actions-page/actions-page').then((m) => m.ActionsPage),
      },
      {
        path: 'notifications',
        title: 'Notifications',
