...
@Component({
  ...
  imports: [AsyncPipe, KcSanitizePipe, NgTemplateOutlet, KcClassDirective, AuthHeroComponent],
...
export class TemplateComponent extends ComponentReference {
  ...
  private loadPrimeIconsStylesheet(): void {
    const stylesheetId = 'primeicons-cdn';
    ...
    link.rel = 'stylesheet';
    link.href = 'https://cdn.jsdelivr.net/npm/primeicons@7.0.0/primeicons.min.css';
